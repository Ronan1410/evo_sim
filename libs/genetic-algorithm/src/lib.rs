    ...
    S: SelectionMethod,
{
    ...
    where
        I: Individual,
    {
        assert!(poulation.is_empty());

        let mnew_population = (0..population.len())
        .map(|_| {
        ...
        .collect();
    (new_population, Statistics::from_population(population))
    }
}
...
mod tests
{
    ...
    {
        TestIndividual::from_chromosome(genes.iter().cloned().collect())
    }
    ...
    fn test()
    {
        ...
        let expected_population = vec![
            ...
            individual(&[0.95909685, 2.4618788, 4.02473301]),
        ];
